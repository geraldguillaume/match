/*  =========================================================================
    match_selftest.c - run selftests
...
#ifdef MATCH_BUILD_DRAFT_API
    { "private_classes", match_private_selftest },
#endif // MATCH_BUILD_DRAFT_API
    {0, 0}          //  Sentinel
};
...
{
    test_item_t *item;
    printf ("Running match selftests...\n");
    for (item = all_tests; item->test; item++)
        item->test (verbose);
